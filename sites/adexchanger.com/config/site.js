...
module.exports = {
  ...
  p1events: {
    ...
    enabled: true,
    cookieDomain: process.env.NODE_ENV === 'production' ? 'adexchanger.com' : '',
  },
  logos: {
    navbar: {
      src: 'https://p1-cms-assets.imgix.net/files/base/accessintel/all/image/static/adex/adex-logo.png?h=50&auto=format,compress',
      srcset: [
        'https://p1-cms-assets.imgix.net/files/base/accessintel/all/image/static/adex/adex-logo.png?h=50&auto=format,compress&dpr=2 2x',
      ],
    },
    footer: {
      src: 'https://p1-cms-assets.imgix.net/files/base/accessintel/all/image/static/adex/adex-logo.png?h=50&auto=format,compress',
  ...
  inquiry: {
    ...
    sendFrom: 'AdExchanger.com <noreply@parameter1.com>',
    logo: 'https://p1-cms-assets.imgix.net/files/base/accessintel/all/image/static/adex/adex-logo.png?h=45&auto=format,compress&bg=000000&pad=5',
    bgColor: '#000000',
  },
