const withContent = require('@access-intelligence/package-global/middleware/with-content');
const contentMeter = require('@access-intelligence/package-global/middleware/content-meter');
const queryFragment = require('@parameter1/base-cms-marko-web-theme-monorail/graphql/fragments/content-page');
const contact = require('@access-intelligence/package-global/templates/content/contact');
